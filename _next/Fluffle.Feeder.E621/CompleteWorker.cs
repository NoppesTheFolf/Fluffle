...
internal class CompleteWorker : BackgroundService
{
    ...
    private readonly ILogger<CompleteWorker> _logger;
    ...
    public CompleteWorker(
        ...
        ILogger<CompleteWorker> logger)
    {
        _e621Client = e621Client;
        _ingestionApiClient = ingestionApiClient;
        _stateRepository = stateRepositoryFactory.Create<E621FeederState>("E621Complete");
        _options = options;
        _logger = logger;
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            await feeder.RunAsync(state, DateTime.MinValue, stoppingToken);
