...
namespace Noppes.Fluffle.TwitterSync.Database.Migrations
{
    ...
    [Migration("20211230222343_AddIndexToSpeedUpSupplyingExistingUsers")]
    partial class AddIndexToSpeedUpSupplyingExistingUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Noppes.Fluffle.TwitterSync.Database.Models.Media", b =>
                {
                    ...
                    b.Property<bool>("IsNotAvailable")
                        .HasColumnType("boolean")
                        .HasColumnName("is_not_available");
            ...
            modelBuilder.Entity("Noppes.Fluffle.TwitterSync.Database.Models.OtherSource", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_other_source");

                    b.ToTable("other_source");
                });
            ...
            modelBuilder.Entity("Noppes.Fluffle.TwitterSync.Database.Models.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("TimelineNextRetrievalAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("timeline_next_retrieval_at");
