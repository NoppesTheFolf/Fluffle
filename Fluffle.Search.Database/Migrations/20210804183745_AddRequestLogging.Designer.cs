...
namespace Noppes.Fluffle.Search.Database.Migrations
{
    ...
    [Migration("20210804183745_AddRequestLogging")]
            ...
            modelBuilder.Entity("Noppes.Fluffle.Search.Database.Models.SearchRequest", b =>
                {
                    ...
                    b.Property<int?>("Start256RgbComputation")
                        .HasColumnType("integer")
                        .HasColumnName("start256_rgb_computation");
                    ...
                    b.Property<int?>("WaitFor256RgbComputation")
                        .HasColumnType("integer")
                        .HasColumnName("wait_for256_rgb_computation");
