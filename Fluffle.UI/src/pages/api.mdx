...
| includeNsfw | An optional boolean value indicating whether or not Fluffle should also search through images deemed Not Safe For Work. By default, Fluffle will not search NSFW images.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| limit       | By default, Fluffle will send you a maximum of 32 results. You can tweak this number by providing a value from 8 to 128. Exceeding this range will cause your request to fail.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| score     | `float`     | A number from 0 to 1 indicating how good of a match the image is. Scores greater than or equal to 0.92 are almost certainly a match. Anything below 0.80 is almost certainly not a match. Scores between 0.80 and 0.92 might indicate an alternative version. Sometimes low scores can also be caused by the submitted image being distorted in a way Fluffle can't correct for. The recommendations around the interpretation of this value might change in the future after a more careful analysis. |
