...
namespace Noppes.Fluffle.Main.Database.Migrations
{
    ...
    [Migration("20210207003449_InitialCreate")]
            ...
            modelBuilder.Entity("Noppes.Fluffle.Main.Database.Models.Content", b =>
                {
                    ...
                    b.Property<string>("PlatformContentId")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("platform_content_id");
                    ...
                    b.HasIndex("PlatformContentId")
                        .HasDatabaseName("idx_content_platform_content_id");
                    ...
                    b.HasIndex("PlatformId", "PlatformContentId")
                        .IsUnique()
                        .HasDatabaseName("uq_content_platform_id_and_platform_content_id");
