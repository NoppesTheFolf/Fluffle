...
namespace Noppes.Fluffle.Main.Database.Migrations
{
    ...
    [Migration("20210307145016_FixInvalidCreditableEntityConstraint")]
    partial class FixInvalidCreditableEntityConstraint
    {
            ...
            modelBuilder.Entity("Noppes.Fluffle.Main.Database.Models.Content", b =>
                {
                    ...
                    b.HasIndex("IdOnPlatformAsInteger")
                        .HasDatabaseName("idx_content_id_on_platform_as_integer");
                    ...
                    b.HasIndex("Discriminator", "ChangeId")
                        .HasDatabaseName("idx_content_discriminator_and_change_id");
                    ...
                    b.HasIndex("PlatformId", "MediaTypeId", "IsIndexed")
                        .HasDatabaseName("idx_content_platform_id_and_media_type_id_and_is_indexed");
